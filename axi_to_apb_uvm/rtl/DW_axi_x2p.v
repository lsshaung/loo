...
// Revision: $Id: //dwh/DW_ocb/DW_axi_x2p/amba_dev/src/DW_axi_x2p.v#12 $ 
*/
//
//
...
module DW_axi_x2p (
  ...
  input [`X2P_APB_DATA_WIDTH-1:0]   prdata_s2; // APB read data slave 2
  ...
  output                            psel_s2; // APB select slave 2
