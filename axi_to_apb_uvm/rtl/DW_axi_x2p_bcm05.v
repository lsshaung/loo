...
// Revision    : $Id: //dwh/DW_ocb/DW_axi_x2p/amba_dev/src/DW_axi_x2p_bcm05.v#14 $
// Author      : Vikas Gokhale       5/17/04
// Description : DW_axi_x2p_bcm05.v Verilog module for DW_axi_x2p
//
// DesignWare IP ID: 38e481b4
//
////////////////////////////////////////////////////////////////////////////////
...
parameter TMR_CDC       = 0;    // RANGE 0 to 1
...
endgenerate
  ...
  DW_axi_x2p_bcm21
   #(COUNT_WIDTH, SYNC_DEPTH+8, 0, GRAY_VERIF_EN, 2) U_sync(
    .clk_d(clk),
    .rst_d_n(rst_n),
    .init_d_n(init_n),
    .data_s(other_addr_g),
...
// SMD: Latch inferred
// SJ: This module was intentionally implemenented with latches within it.
